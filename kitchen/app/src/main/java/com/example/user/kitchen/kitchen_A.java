...
public class kitchen_A extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kitchen1);
        ...
        dref.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                for (DataSnapshot postSnapshot: dataSnapshot.getChildren()){
                    ...
                    if (data2[0].equals("全雞")){
                        n0++;
                        String AC = String.valueOf(n0);
                        quantity1.setText(AC);
                        uploaddref = FirebaseDatabase.getInstance().getReference("").child("及時統計資料/下單中/全雞");
                        uploaddref.setValue(AC);
                    }
                    else if (data2[0].equals("半雞")){
                        n1++;
                        String AC = String.valueOf(n1);
                        quantity2.setText(AC);
                        uploaddref = FirebaseDatabase.getInstance().getReference("").child("及時統計資料/下單中/半雞");
                        uploaddref.setValue(AC);
                    }
                    else if (data2[0].equals("雞腿")){
                        n2++;
                        String AC = String.valueOf(n2);
                        quantity3.setText(AC);
                        uploaddref = FirebaseDatabase.getInstance().getReference("").child("及時統計資料/下單中/雞腿");
                        uploaddref.setValue(AC);
                    }
                }
            }
        ...
        downloaddref.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                else if (point.equals("半雞")){
                    String AC = dataSnapshot.getValue().toString();
                    quantity5.setText(AC);
                }
                else if (point.equals("雞腿")){
                    String AC = dataSnapshot.getValue().toString();
    ...
    private ListView.OnItemClickListener listViewOnItemClickListener
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            if (data[0].equals("全雞")){
                ...
                quantity4.setText(AC);
                updatedref = FirebaseDatabase.getInstance().getReference("").child("及時統計資料/備料中/全雞");
                updatedref.setValue(AC);
            }
            else if (data[0].equals("半雞")){
                n1--;
                String AC = String.valueOf(n1);
                quantity2.setText(AC);
                uploaddref = FirebaseDatabase.getInstance().getReference("").child("及時統計資料/下單中/半雞");
                ...
                quantity5.setText(AC);
                updatedref = FirebaseDatabase.getInstance().getReference("").child("及時統計資料/備料中/半雞");
                updatedref.setValue(AC);
            }
            else if (data[0].equals("雞腿")){
                n2--;
                String AC = String.valueOf(n2);
                quantity3.setText(AC);
                uploaddref = FirebaseDatabase.getInstance().getReference("").child("及時統計資料/下單中/雞腿");
                ...
                quantity6.setText(AC);
                updatedref = FirebaseDatabase.getInstance().getReference("").child("及時統計資料/備料中/雞腿");
                updatedref.setValue(AC);
            }
            determine();
        }};
    ...
    public Button.OnClickListener buttonclicklistener = new Button.OnClickListener(){
        ...
        public void onClick(View v){
            ...
            switch (v.getId()) {
                case R.id.button: {
                    AlertDialog.Builder editDialog = new AlertDialog.Builder(kitchen_A.this);
                    editDialog.setTitle("更變全雞數量(請直接輸入增加的數量)");

                    final EditText editText = new EditText(kitchen_A.this);
                ...
                case R.id.button1: {
                    AlertDialog.Builder editDialog = new AlertDialog.Builder(kitchen_A.this);
                    editDialog.setTitle("更變半雞數量(請直接輸入增加的數量)");
                ...
                case R.id.button2:{
                    AlertDialog.Builder editDialog = new AlertDialog.Builder(kitchen_A.this);
                    editDialog.setTitle("更變雞腿數量(請直接輸入增加的數量)");
    ...
    void determine(){
        ...
        if (a-A>=3){
            ...
            uploaddref = FirebaseDatabase.getInstance().getReference("").child("及時統計資料/數量狀態/全雞");
        ...
        if (b-B>=3){
            ...
            uploaddref = FirebaseDatabase.getInstance().getReference("").child("及時統計資料/數量狀態/半雞");
            uploaddref.setValue("3");
        }
        else if (b-B>=1 & b-B<3){
        ...
        if (c-C>=3){
            ...
            uploaddref = FirebaseDatabase.getInstance().getReference("").child("及時統計資料/數量狀態/雞腿");
            uploaddref.setValue("3");
        }
        else if (c-C>=1 & c-C<3){
